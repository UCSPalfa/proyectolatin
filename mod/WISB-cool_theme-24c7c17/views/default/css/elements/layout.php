...
/* AUMENTADO ELGG-PAGE*/
.elgg-page{min-height:100%;position:relative;}
/* AUMENTADO ELGG-PAGE-BODY*/
.elgg-page-body{padding-bottom:95px;}
/* <style>
/* ***************************************
	PAGE LAYOUT
*************************************** */
/***** DEFAULT LAYOUT ******/
.elgg-page-default .elgg-page-header > .elgg-inner {width: 981px;margin: 0 auto;height: 128px; background: url(<?php echo $url; ?>_graphics/banner_latin.png) 0 0 no-repeat; background-size: 995px 128px;}.elgg-page-default .elgg-page-body > .elgg-inner {width: 981px;margin: 0 auto;}.elgg-page-footer > .elgg-inner:after {display:block;content: '.';clear:both;visibility:hidden;height:0;}
/***** TOPBAR ******/
...
.bloque_t1 h2{color:#0054A7; font-weight:bold}
.bloque_t2{width: 45%; float:right; margin-top: 30px;border:1px solid silver;border-bottom-left-radius:8px;border-bottom-right-radius:8px;border-top-left-radius:8px;border-top-right-radius:8px;height:280px;padding:10px;position:relative}
.bloque_t2{background-image: url(<?php echo $url; ?>_graphics/p_box.gif);background-position: 50% 100%;background-repeat: no-repeat no-repeat; margin-right: 0; background-size: 100%}
.bloque_t2 h2{color:#0054A7; font-weight:bold}
.elgg-sidebar-right .elgg-head{background-color:#fff; border-top:0; border-bottom-color: #CCCCCC; border-bottom-style: solid; border-bottom-width:1px; margin-bottom: 5px;}
.elgg-sidebar-right .elgg-head h3{font-size: 14px; color:#0054A7; font-weight: bold}
/*Login form de página principal*/
.elgg-form-login label{color: #333333; font-weight:bold; font-size: 13px}
.elgg-form-login .elgg-input-text{width: 100%}
